 ...
 * @author Frederico
 */
public class CompraGrid extends javax.swing.JDialog {
    
    private static CompraGrid grid;

    private IControleSimples controle;
    private CompraTableModel model;

    /**
     * Creates new form CompraGrid
     */
    public CompraGrid(java.awt.Frame parent, boolean modal, IControleSimples controle, CompraTableModel model) {
        super(parent, modal);
    ...
    public static CompraGrid getInstance(Frame parent, boolean modal, IControleSimples controle, CompraTableModel model) {
        if (grid == null) {
        ...
        //</editor-fold>   
            return new CompraGrid(parent, modal, controle, model);
        } else {
            return grid;
        }
    }
        ...
        panPrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(panPrincipalLayout.createSequentialGroup()
                ...
                .addGroup(panPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panGrid, javax.swing.GroupLayout.DEFAULT_SIZE, 512, Short.MAX_VALUE)
                    .addGroup(panPrincipalLayout.createSequentialGroup()
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        Compra objetoLinha = model.getObjetoLinha(selectedRow);

 ...
 * @author alessio
 */
public class FornecedorGrid extends javax.swing.JDialog {

    private static FornecedorGrid grid;
     ...
     * @param modal
     */
    private FornecedorGrid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }

    private FornecedorGrid(java.awt.Frame parent, boolean modal, IControleSimples controle) {
        this(parent, modal);
        this.controle = controle;
    }

    public FornecedorGrid(Frame parent, boolean modal, IControleSimples controle, FornecedorTableModel model) {
        this(parent, modal, controle);
        this.model = model;
        initComponents();
    }

    public static FornecedorGrid getInstance(Frame parent, boolean modal, IControleSimples controle, FornecedorTableModel model) {
        if (grid == null) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(FornecedorGrid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }
            //</editor-fold>
            //</editor-fold>
            return new FornecedorGrid(parent, modal, controle, model);
        } else {
            return grid;
        }
    }
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        Fornecedor objetoLinha = model.getObjetoLinha(selectedRow);

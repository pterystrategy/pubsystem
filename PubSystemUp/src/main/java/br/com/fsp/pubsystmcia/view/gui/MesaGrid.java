 ...
 * @author alessio
 */
public class MesaGrid extends javax.swing.JDialog {

    private static MesaGrid grid;

    private IControleSimples controle;
    private MesaTableModel model;
     ...
     * @param modal
     */
    private MesaGrid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }

    private MesaGrid(java.awt.Frame parent, boolean modal, IControleSimples controle) {
        this(parent, modal);
        this.controle = controle;
    }

    public MesaGrid(Frame parent, boolean modal, IControleSimples controle, MesaTableModel model) {
        this(parent, modal, controle);
        this.model = model;
        initComponents();
    }

    public static MesaGrid getInstance(Frame parent, boolean modal, IControleSimples controle, MesaTableModel model) {
        if (grid == null) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(MesaGrid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }
            //</editor-fold>
            //</editor-fold>
            return new MesaGrid(parent, modal, controle, model);
        } else {
            return grid;
        }
    }
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        Mesa objetoLinha = model.getObjetoLinha(selectedRow);

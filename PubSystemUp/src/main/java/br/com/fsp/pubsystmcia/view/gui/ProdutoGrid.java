 ...
 * @author alessio
 */
public class ProdutoGrid extends javax.swing.JDialog {

    private static ProdutoGrid grid;
     ...
     * @param modal
     */
    private ProdutoGrid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }

    private ProdutoGrid(java.awt.Frame parent, boolean modal, IControleSimples controle) {
        this(parent, modal);
        this.controle = controle;
    }

    public ProdutoGrid(Frame parent, boolean modal, IControleSimples controle, ProdutoTableModel model) {
        this(parent, modal, controle);
        this.model = model;
        initComponents();
    }

    public static ProdutoGrid getInstance(Frame parent, boolean modal, IControleSimples controle, ProdutoTableModel model) {
        if (grid == null) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(ProdutoGrid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }
            //</editor-fold>
            //</editor-fold>
            return new ProdutoGrid(parent, modal, controle, model);
        } else {
            return grid;
        }
    }
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        Produto objetoLinha = model.getObjetoLinha(selectedRow);
